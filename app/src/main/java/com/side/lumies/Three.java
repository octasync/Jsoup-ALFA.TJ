...
public class Three extends Fragment {
    ...
    public boolean isInternetAvailable() {
        try {
            InetAddress ipAddr = InetAddress.getByName("http://alfa.tj");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        noinet = v.findViewById(R.id.noinet);
    ...
    class Size extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            try {
                ...
                doc2 = Jsoup.connect("http://alfa.tj/smart/favorite").cookie("sessionVal", sessionId).get();
