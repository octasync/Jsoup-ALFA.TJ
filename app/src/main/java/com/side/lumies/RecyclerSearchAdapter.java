...
public class RecyclerSearchAdapter extends RecyclerView.Adapter<RecyclerSearchAdapter.ViewHolder> {
    ...
    ArrayList<String> video_streams = new ArrayList<>();
    Context context;

    public MyAdapterListener onClickListener;


    public RecyclerSearchAdapter(Context applicationContext, ArrayList<String> id, ArrayList<String> title, ArrayList<String> description, ArrayList<String> times,
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            titleTextView = itemView.findViewById(R.id.dops2);
            time = itemView.findViewById(R.id.timeLapse);
            descriptionTextView = itemView.findViewById(R.id.description);
            channel = itemView.findViewById(R.id.nameOfChannel);
    ...
    public RecyclerSearchAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_view3, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        if (s.equals("/")) { Picasso.get().load("http://mix.tj" + description.get(position)).into(holder.idTextView); }

        else{ Picasso.get().load(description.get(position)).into(holder.idTextView); }
        ...
        holder.channel.setText(channels.get(position));
        holder.titleTextView.setText(getClocks(clocks.get(position))+" · "+getSees(views.get(position)));
